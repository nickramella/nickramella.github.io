    ...
    <div className="h-screen">
      <div className={`my-25 ${isSmallScreen ? "mx-3" : "mx-10"} anim-fade`}>
        ...
        <DemoModal
          ...
          description={`Here is a simplified version of a payroll comparison widget I've worked on for an HR Portal. Click the button ${isSmallScreen? "above" : "to the left"} and start the demo. 
