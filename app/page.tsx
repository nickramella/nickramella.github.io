      ...
      <div className={`p-6 ${!isSmallScreen && "flex"}`}>
        <div className={`${!isSmallScreen ? "w-[50%]" : "pb-3"}`}>
          ...
          <div className="flex justify-center py-3">
            <a href="https://www.linkedin.com/in/nicholas-ramella-8b605618a" target="_blank"><i className="fa fa-linkedin-square text-[3vw] hover:text-blue-500"></i></a>
            <a href="https://github.com/nickramella" target="_blank"><i className="fa fa-github w-8 text-[3vw] hover:text-blue-500"></i></a>
        </div>
        </div>
